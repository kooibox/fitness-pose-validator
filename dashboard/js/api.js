...
const API = {
    ...
    async getTrend(metric = 'squats', period = '30d', clientId = null) {
        const url = new URL(`${API_BASE}/dashboard/trend`);
    ...
    async getDistribution(metric = 'depth', sessionId = null, clientId = null) {
        const url = new URL(`${API_BASE}/dashboard/distribution`);
        url.searchParams.append('metric', metric);
    ...
    async getHeatmap(period = '90d', clientId = null) {
        const url = new URL(`${API_BASE}/dashboard/heatmap`);
        url.searchParams.append('period', period);
        if (clientId) url.searchParams.append('client_id', clientId);
    ...
    async getRadar(clientId = null) {
        const url = new URL(`${API_BASE}/dashboard/radar`);
        if (clientId) url.searchParams.append('client_id', clientId);
    ...
    async getBestRecords(limit = 5, clientId = null) {
        const url = new URL(`${API_BASE}/dashboard/best-records`);
    ...
    async getRecentSessions(limit = 10, clientId = null) {
        const url = new URL(`${API_BASE}/dashboard/recent-sessions`);
        url.searchParams.append('limit', limit);
        if (clientId) url.searchParams.append('client_id', clientId);
