...
async def get_overview(
    ...
    - **exercise_type**: 可选，运动类型 (squat/pushup/lunge)
    - **client_id**: 可选，指定客户端ID
    """
    stats = analyzer.get_overview_stats(client_id, exercise_type)
...
async def get_trend(
    ...
    - **exercise_type**: 可选，运动类型
    - **client_id**: 可选，指定客户端ID
    """
    data = analyzer.get_trend_data(metric, period, client_id, exercise_type)
...
async def get_distribution(
    ...
    - **client_id**: 可选，指定客户端ID
    """
    data = analyzer.get_distribution_data(metric, session_id, client_id, exercise_type)
    return {"status": "success", "data": data}
...
async def get_heatmap(
    ...
    - **client_id**: 可选，指定客户端ID
    """
    data = analyzer.get_heatmap_data(period, client_id, exercise_type)
    return {"status": "success", "data": data}
...
async def get_radar(
    ...
    - **client_id**: 可选，指定客户端ID
    """
    data = analyzer.get_radar_data(client_id, exercise_type)
    return {"status": "success", "data": data}
...
async def get_best_records(
    ...
    - **client_id**: 可选，指定客户端ID
    """
    records = analyzer.get_best_records(limit, client_id, exercise_type)
...
async def get_recent_sessions(
    ...
    - **client_id**: 可选，指定客户端ID
    """
    sessions = analyzer.get_recent_sessions(limit, client_id, exercise_type)
